...
#### * SSR, SSG의 차이
SSR : 매 요청마다 HTML을 생성하기 때문에 비교적 응답 속도가 느리고, 서버에 더 많은 부담이 간다. (새로고침 시에도 빌드)
<br/>
...
: 클라이언트(사용자) 측에서 처리하는 것. <sup>프론트엔드</sup>
<br/>
